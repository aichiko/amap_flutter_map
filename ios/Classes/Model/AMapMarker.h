...
// 是否为 AnimatedAnnotation
@property (nonatomic, assign) bool animated;

//根据以上marker信息生成的对应的iOS端的Annotation
@property (nonatomic, strong, readonly) __kindof MAPointAnnotation *annotation;

// 根据以上marker信息生成的对应的iOS端的 AnimatedAnnotation 可用于平滑移动
//@property (nonatomic, strong, readonly) MAAnimatedAnnotation *animated_annotation;
