...
import com.amap.flutter.map.location.amaplocationflutterplugin.AmapLocationFlutterPlugin;
...
public class AMapFlutterMapPlugin implements
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
        ...
        // 加入定位插件
        AmapLocationFlutterPlugin locationFlutterPlugin = new AmapLocationFlutterPlugin();
        binding.getFlutterEngine().getPlugins().add(locationFlutterPlugin);
    }
