...
class MarkerController implements MarkerOptionsSink {
    ...
    MarkerController(SmoothMoveMarker smoothMoveMarker) {
        this.moveMarker = smoothMoveMarker;
        this.marker = smoothMoveMarker.getMarker();
        this.markerId = smoothMoveMarker.getMarker().getId();
    }

    public SmoothMoveMarker getMoveMarker() {
        return moveMarker;
    }
